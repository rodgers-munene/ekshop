      ...
      {!refreshing && section === "overview" && overview && (
        <div className="space-y-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard label="GMV" value={formatKES(overview.totals.gmv_total)} />
            <StatCard label="Delivery Service Revenue" value={formatKES(overview.totals.delivery_revenue_total)} />
          </div>
