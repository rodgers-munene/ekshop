...
class AutomationSettings(Base):
    ...
    alert_gross_margin_enabled = Column(Boolean, nullable=False, default=True)
    alert_order_cancellation_enabled = Column(Boolean, nullable=False, default=True)
    alert_cart_abandonment_enabled = Column(Boolean, nullable=False, default=True)
    alert_on_time_delivery_enabled = Column(Boolean, nullable=False, default=True)
